...
from solei.email.schemas import OAuth2LeakedTokenEmail, OAuth2LeakedTokenProps
...
from solei.models import OAuth2Token, User
        ...
        *,
        ...
        for recipient in recipients:
            enqueue_email_template(
                ...
                subject="Security Notice - Your Solei Access Token has been leaked",
            )
