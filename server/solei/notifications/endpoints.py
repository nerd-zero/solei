...
from solei.notification_recipient import (
    auth as notification_recipient_auth,
)
from solei.notification_recipient.schemas import (
    NotificationRecipientCreate,
    NotificationRecipientPlatform,
    NotificationRecipientSchema,
)
from solei.notification_recipient.service import (
    notification_recipient as notification_recipient_service,
)
from solei.notifications import (
