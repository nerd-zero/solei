...
from solei.locker import TimeoutLockError
from solei.logging import Logger
from solei.observability import OPERATIONAL_ERROR_TOTAL
...
def _external_event_already_handled_error_matcher(exc: BaseException) -> bool:
    ...
    from solei.external_event.service import ExternalEventAlreadyHandled
...
def _loops_client_operational_error_matcher(exc: BaseException) -> bool:
    # Import deferred to avoid circular dependency with polar.worker
    from solei.integrations.loops.client import LoopsClientOperationalError
