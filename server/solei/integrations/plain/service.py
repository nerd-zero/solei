...
class PlainServiceError(SoleiError): ...
...
class PlainService:
    ...
    async def create_organization_review_thread(
        ...
        if organization.account is None:
            from solei.organization.tasks import OrganizationAccountNotSet
    ...
    async def _get_snippets_card(
        ...
        snippets: list[tuple[str, str]] = [
            ...
            (
                ...
                (
                    "I'm looping in the {organization_name} team to the conversation so that they can help you. "
                    "Please allow them up to 48 hours to get back to you ([guidelines for merchants on Solei](https://solei.to/docs/merchant-of-record/account-reviews#operational-guidelines))."
                ),
            ),
            (
                "Cancellation Portal",
                (
                    "You can perform the cancellation on the following URL: https://solei.to/{organization_slug}/portal\n"
                ),
            ),
            (
                "Invoice Generation",
                (
                    "You can generate the invoice on the following URL: https://solei.to/{organization_slug}/portal\n"
                ),
            ),
            (
                "Follow-up 48 hours",
                (
                    ...
                    "Please allow them another 48 hours to get back to you before we [proceed with the documented resolution](https://solei.to/docs/merchant-of-record/account-reviews#expected-responsiveness)."
                ),
            ),
            (
                "Follow-up Reply All",
    ...
    def _build_review_message(self, organization_name: str, issues: OrgIssues) -> str:
        ...
        lines: list[str] = [
            f"Welcome to Solei! Your organization {organization_name} is currently being reviewed. "
            ...
            "You can keep using Solei in the mean time to set up your products and integration.",
            "",
        ]
        ...
        lines.append("Cheers,")
        lines.append("")
        lines.append("The customer success team at Solei")
