...
from solei.integrations.github.client import GitHub, TokenAuthStrategy
...
class GithubUserServiceError(SoleiError): ...
...
class CannotLinkUnverifiedEmailError(GithubUserServiceError):
    def __init__(self, email: str) -> None:
        message = (
            f"An account already exists on Solei under the email {email}. "
...
class AccountLinkedToAnotherUserError(GithubUserServiceError):
    def __init__(self) -> None:
        message = (
            "This GitHub account is already linked to another user on Solei. "
