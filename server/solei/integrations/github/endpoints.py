...
from solei.auth.dependencies import WebUserOrAnonymous, WebUserWrite
from solei.auth.models import is_user
...
from solei.user.schemas import UserSignupAttribution, UserSignupAttributionQuery
