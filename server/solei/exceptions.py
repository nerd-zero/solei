...
class SoleiError(Exception):
    """
    Base exception class for all errors raised by Solei.
...
class SoleiTaskError(SoleiError):
    """
...
class SoleiRedirectionError(SoleiError):
    """
...
class InternalServerError(SoleiError):
    def __init__(
...
class ResourceNotFound(SoleiError):
...
class SoleiRequestValidationError(SoleiError):
