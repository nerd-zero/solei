...
from solei.enums import EmailSender, TaxProcessor
from solei.kit.address import Address, CountryAlpha2
from solei.kit.jwk import JWKSFile
...
env = Environment(os.getenv("SOLEI_ENV", Environment.development))
...
class Settings(BaseSettings):
    ...
    CURRENT_JWK_KID: str = "solei_dev"
    WWW_AUTHENTICATE_REALM: str = "solei"
    ...
    CHECKOUT_LINK_HOST: str | None = None  # e.g., "buy.solei.to" in production
    ...
    USER_SESSION_COOKIE_KEY: str = "solei_session"
    ...
    IMPERSONATION_COOKIE_KEY: str = "solei_original_session"
    IMPERSONATION_INDICATOR_COOKIE_KEY: str = "solei_is_impersonating"
    ...
    OAUTH_STATE_COOKIE_KEY: str = "solei_oauth_state"
    ...
    STRIPE_STATEMENT_DESCRIPTOR: str = "SOLEI"
    ...
    PAYOUT_INVOICES_PREFIX: str = "SOLEI-"
    ...
    def frontend_hostname(self) -> str:
        return urlparse(self.FRONTEND_BASE_URL).hostname or "solei.to"
