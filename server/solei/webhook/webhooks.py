...
from solei.benefit.schemas import Benefit as BenefitSchema
from solei.benefit.schemas import BenefitGrantWebhook
from solei.checkout.schemas import Checkout as CheckoutSchema
from solei.customer.schemas.customer import Customer as CustomerSchema
from solei.customer.schemas.state import CustomerState as CustomerStateSchema
from solei.customer_seat.schemas import CustomerSeat as CustomerSeatSchema
from solei.exceptions import SoleiError
from solei.integrations.discord.webhook import (
    DiscordEmbedField,
    DiscordPayload,
    get_branded_discord_embed,
)
from solei.kit.schemas import IDSchema, Schema
from solei.member.schemas import Member as MemberSchema
...
from solei.order.schemas import Order as OrderSchema
from solei.organization.schemas import Organization as OrganizationSchema
from solei.product.schemas import Product as ProductSchema
from solei.refund.schemas import Refund as RefundSchema
from solei.subscription.schemas import Subscription as SubscriptionSchema
...
class UnsupportedTarget(SoleiError):
    def __init__(
        self,
