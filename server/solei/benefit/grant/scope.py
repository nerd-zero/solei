...
from solei.models.benefit_grant import BenefitGrantScope, BenefitGrantScopeArgs
from solei.models.order import Order
...
class BenefitGrantScopeError(SoleiError): ...
