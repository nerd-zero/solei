...
from solei.integrations.discord.service import discord_bot as discord_bot_service
from solei.logging import Logger
from solei.member.repository import MemberRepository
from solei.models import Benefit, Customer, Member, Organization, User
                ...
                [
                    {
                        ...
                        "msg": "This role is above the Solei bot role, so Discord won't let our bot grants it. Please reorder them so the Solei bot is above.",
                        "loc": ("role_id",),
                        "input": role_id,
                    }
                ]
