...
from solei.exceptions import NotPermitted, ResourceNotFound, SoleiRequestValidationError
from solei.kit.pagination import PaginationParams
from solei.kit.sorting import Sorting
from solei.models.customer import Customer, CustomerType
from solei.models.member import Member, MemberRole
from solei.models.organization import Organization as OrgModel
...
class MemberService:
    ...
    async def delete(
        ...
        Raises:
            SoleiRequestValidationError: If trying to delete the only owner
        """
        repository = MemberRepository.from_session(session)
    ...
    async def delete_by_customer(
        ...
        """
        from solei.benefit.grant.service import (
