...
from solei.custom_field.schemas import AttachedCustomField
from solei.customer.schemas.customer import CustomerNameInput
...
from solei.kit.http import SuccessUrl
from solei.kit.locale import Locale
...
from solei.organization.schemas import OrganizationPublicBase
...
EmbedOrigin = Annotated[
    ...
    Field(
        description=(
            ...
            "It'll allow the Solei iframe to communicate with the parent page."
        ),
    ),
]
...
_external_customer_id_description = (
    ...
    "If a matching customer exists on Solei, the resulting order "
