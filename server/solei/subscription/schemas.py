...
from solei.kit.metadata import MetadataInputMixin, MetadataOutputMixin
...
from solei.meter.schemas import Meter
from solei.models.subscription import CustomerCancellationReason, SubscriptionStatus
from solei.product.schemas import Product, ProductPrice
...
class SubscriptionCreateExternalCustomer(SubscriptionCreateBase):
    ...
    external_customer_id: str = Field(
        description=(
            ...
            "It must already exist in Solei."
        )
    )
