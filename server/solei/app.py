...
from solei import worker  # noqa
from solei.api import router
from solei.auth.middlewares import AuthSubjectMiddleware
from solei.backoffice import app as backoffice_app
from solei.checkout import ip_geolocation
from solei.checkout_link.app import app as checkout_link_redirect_app
from solei.config import settings
from solei.exception_handlers import add_exception_handlers
from solei.health.endpoints import router as health_router
from solei.kit.cors import CORSConfig, CORSMatcherMiddleware, Scope
from solei.kit.db.postgres import (
    AsyncEngine,
    AsyncSessionMaker,
    Engine,
    SyncSessionMaker,
...
from solei.oauth2.endpoints.well_known import router as well_known_router
from solei.oauth2.exception_handlers import OAuth2Error, oauth2_error_exception_handler
from solei.observability.http_middleware import HttpMetricsMiddleware
from solei.observability.memory_profile import (
    start_memory_profiler,
    stop_memory_profiler,
)
from solei.observability.remote_write import (
    start_remote_write_pusher,
    stop_remote_write_pusher,
)
from solei.observability.slo import start_slo_metrics, stop_slo_metrics
from solei.openapi import OPENAPI_PARAMETERS, APITag, set_openapi_generator
...
from solei.search.endpoints import router as search_router
from solei.sentry import configure_sentry
from solei.webhook.webhooks import document_webhooks
...
def configure_cors(app: FastAPI) -> None:
    ...
    # Solei frontend CORS configuration
