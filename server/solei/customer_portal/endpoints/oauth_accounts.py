...
from solei.auth.models import Customer, Member, is_anonymous, is_customer, is_member
from solei.benefit.grant.repository import BenefitGrantRepository
from solei.benefit.strategies.base.service import BenefitActionRequiredError
...
from solei.integrations.discord.oauth import user_client as discord_user_client
from solei.integrations.github.client import Forbidden
from solei.kit import jwt
from solei.kit.http import ReturnTo, add_query_parameters, get_safe_return_url
...
from solei.models.customer import CustomerOAuthAccount, CustomerOAuthPlatform
...
class OAuthCallbackError(SoleiError):
