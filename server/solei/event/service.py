...
from solei.kit.metadata import MetadataQuery
...
from solei.meter.aggregation import PropertyAggregation
from solei.meter.filter import Filter
...
from solei.worker import enqueue_events, enqueue_job
...
def _topological_sort_events(events: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    Handles parent_id references that can be either Solei IDs or external_id strings.
