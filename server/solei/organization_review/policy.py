...
FALLBACK_POLICY = """
    ...
    **General rule of acceptable services**
    ...
    1. Solei on your behalf (License Keys, File Downloads, GitHub- or Discord invites or private links, e.g premium YouTube videos etc)
    ...
    * Threatens reputation of Solei or any of our partners and payment providers
    ...
    * Marketplaces. Selling others' products or services using Solei against an upfront payment or with an agreed upon revenue share.
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                "https://solei.to/docs/merchant-of-record/acceptable-use.md",
                timeout=10.0,
