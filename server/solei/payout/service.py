...
from solei.kit.db.postgres import AsyncSessionMaker
...
from solei.models import Account, Payout, PayoutAttempt
        ...
        async with locker.lock(lock_name, timeout=60, blocking_timeout=1):
            ...
            payout = await repository.create(
                Payout(
                    ...
                    currency="usd",  # FIXME: Main Solei currency
