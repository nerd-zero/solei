...
if TYPE_CHECKING:
    from solei.benefit.strategies import BenefitProperties
    from solei.models import BenefitGrant, Organization


class TaxApplicationMustBeSpecified(SoleiError):
