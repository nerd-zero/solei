...
class PledgeState(StrEnum):
    # Initiated by customer. Solei has not received money yet.
    initiated = "initiated"
    ...
    refunded = "refunded"
    # The pledge was disputed by the customer (via Solei)
    disputed = "disputed"
    # The charge was disputed by the customer (via Stripe, aka "chargeback")
    charge_disputed = "charge_disputed"
    # Manually cancelled by a Solei admin.
    cancelled = "cancelled"
...
class PledgeType(StrEnum):
    # Up front pledges, paid to Solei directly, transfered to maintainer when completed.
