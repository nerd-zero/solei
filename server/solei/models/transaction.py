...
class TransactionType(StrEnum):
    ...
    payment = "payment"
    """Solei received a payment."""
    processor_fee = "processor_fee"
    """A payment processor fee was charged to Solei."""
    refund = "refund"
    """Solei refunded a payment (totally or partially)."""
    refund_reversal = "refund_reversal"
    """A Solei refund is reversed (totally or partially)."""
    dispute = "dispute"
    """A Solei payment is disputed (totally or partially)."""
    dispute_reversal = "dispute_reversal"
    """A Solei payment dispute is reversed (totally or partially)."""
    balance = "balance"
    """Money flow between Solei and a user's account."""
    payout = "payout"
    """Money paid to the user's bank account."""
    payout_reversal = "payout_reversal"
    """A payout is reversed back to Solei (totally or partially)."""
...
class ProcessorFeeType(StrEnum):
    ...
    """
    Fee applied when money is transferred to a different country than Solei's.
...
class PlatformFeeType(StrEnum):
    """
    Type of fees applied by Solei, and billed to the users.
    """
...
class Transaction(RecordModel):
    """
    Represent a money flow in the Solei system.
    """
    ...
    """Currency of this transaction from Solei's perspective. Should be `usd`."""
    amount: Mapped[int] = mapped_column(BigInteger, nullable=False)
    """Amount in cents of this transaction from Solei's perspective."""
    ...
    """Amount of tax in the presentment currency collected by Solei for this payment."""
    ...
    """Amount of tax filed to the jurisdiction by Solei for this payment."""
    tax_filing_currency: Mapped[str | None] = mapped_column(String(3), nullable=True)
    """Currency in which the tax was filed to the jurisdiction by Solei."""
    ...
    If `None`, this transaction concerns Solei directly.
    """
