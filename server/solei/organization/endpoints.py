...
from solei.account.schemas import Account as AccountSchema
from solei.account.service import account as account_service
from solei.auth.models import is_anonymous, is_user
from solei.auth.scope import Scope
from solei.config import settings
from solei.email.schemas import OrganizationInviteEmail, OrganizationInviteProps
...
from solei.kit.pagination import ListResource, Pagination, PaginationParamsQuery
from solei.models import Account, Organization
from solei.openapi import APITag
from solei.organization.repository import OrganizationReviewRepository
...
from solei.user_organization.schemas import OrganizationMember, OrganizationMemberInvite
...
async def invite_member(
    ...
    enqueue_email_template(
        ...
        to_email_addr=email,
        subject=f"You've been invited to {organization.name} on Solei",
    )
