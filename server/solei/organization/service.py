...
from solei.enums import InvoiceNumbering
from solei.exceptions import NotPermitted, SoleiError, SoleiRequestValidationError
...
from solei.kit.anonymization import anonymize_email_for_deletion, anonymize_for_deletion
from solei.kit.currency import PresentmentCurrency
from solei.kit.pagination import PaginationParams
from solei.kit.repository import Options
...
from solei.organization_access_token.repository import OrganizationAccessTokenRepository
from solei.organization_review.repository import (
...
from solei.postgres import AsyncReadSession, AsyncSession, sql
...
class OrganizationError(SoleiError): ...
...
class OrganizationService:
    ...
    async def delete(
        ...
        if organization._avatar_url:
            # Anonymize by setting to Solei logo
