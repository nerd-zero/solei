...
from solei.kit.metadata import add_metadata_query_schema
from solei.oauth2.schemas import add_oauth2_form_schemas
        ...
        return [
            {
                "name": cls.public,
                "description": (
                    "Endpoints shown and documented in the Solei API documentation "
...
OPENAPI_PARAMETERS: OpenAPIParameters = {
    "title": "Solei API",
    "summary": "Solei HTTP and Webhooks API",
    "version": "0.1.0",
    "description": "Read the docs at https://solei.to/docs/api-reference",
    "docs_url": None
    ...
    "servers": [
        {
            "url": "https://api.solei.to",
            "description": "Production environment",
            "x-speakeasy-server-id": "production",
        },
        {
            "url": "https://sandbox-api.solei.to",
