...
from solei.kit.anonymization import (
...
from solei.models import BenefitGrant, Customer, Organization, User
...
from solei.tax.tax_id import InvalidTaxID, validate_tax_id
...
class CustomerService:
    ...
    async def get_state(
        ...
        cache_key = f"solei:customer_state:v4:{customer.id}"
