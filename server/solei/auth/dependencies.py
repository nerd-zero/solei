...
from solei.auth.scope import RESERVED_SCOPES, Scope
from solei.exceptions import Unauthorized
from solei.oauth2.exceptions import InsufficientScopeError
...
pat_scheme = HTTPBearer(
    scheme_name="pat",
    auto_error=False,
    description="You can generate a **Personal Access Token** from your [settings](https://solei.to/settings).",
)
