...
export const useOrganizationAccount = (
  ...
  return useQuery({
    ...
    queryFn: () =>
      fetch(
        `${process.env.EXPO_PUBLIC_SOLEI_SERVER_URL}/v1/organizations/${organizationId}/account`,
        {
          headers: {
...
export const useTransactionsSummary = (
  ...
  return useQuery({
    ...
    queryFn: () =>
      fetch(
        `${process.env.EXPO_PUBLIC_SOLEI_SERVER_URL}/v1/transactions/summary?account_id=${accountId}`,
        {
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${session}`,
...
export const usePayoutEstimate = (
  ...
  return useQuery({
    ...
    queryFn: () =>
      fetch(
        `${process.env.EXPO_PUBLIC_SOLEI_SERVER_URL}/v1/payouts/estimate?account_id=${accountId}`,
        {
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${session}`,
...
export const useCreatePayout = (
  ...
  return useMutation({
    mutationFn: () =>
      fetch(`${process.env.EXPO_PUBLIC_SOLEI_SERVER_URL}/v1/payouts/`, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${session}`,
        },
