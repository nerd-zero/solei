...
export const useOAuthConfig = () => {
  const production = {
    ...
    discovery: {
      authorizationEndpoint: 'https://solei.to/oauth2/authorize',
      tokenEndpoint: 'https://api.solei.to/v1/oauth2/token',
      registrationEndpoint: 'https://api.solei.to/v1/oauth2/register',
      revocationEndpoint: 'https://api.solei.to/v1/oauth2/revoke',
    },
  }
