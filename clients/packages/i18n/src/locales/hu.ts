export default {
  checkout: {
    footer: {
      ...
      mandateOneTime:
        'A(z) „{buttonLabel}” gombra kattintva Ön felhatalmazza a Nerd Zero (Pvt) Ltd.-et, online viszonteladónkat és hivatalos kereskedőnket, hogy megterhelje a kiválasztott fizetési módot a fent feltüntetett összeggel. Ez egy egyszeri terhelés.',
    },
    form: {
      email: 'E-mail cím',
