...
1. Point the Webhook to `your-app.com/webhooks/polar`. This must be an absolute URL which Solei can reach. If you use the Solei CLI tunnel, it will handle this for you.
