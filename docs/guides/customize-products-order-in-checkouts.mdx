...
<Steps>
    ...
    <Step title =  "Go to the Products Catalogue">
        ...
        You can also go directly to `https://solei.to/dashboard/${org_slug}/products`.
...
<Steps>
    <Step title = "Create a Checkout Link using the API">
        ...
        ```bash Terminal
        curl --request POST \
            --url https://api.solei.to/v1/checkout-links/ \
        ...
        ```
    Find all the available parameters along with the description in the  [Create Checkout Link API](https://solei.to/docs/api-reference/checkout-links/create).
    </Step>
    <Step title="Open the Checkout Link URL">
        ...
        ```json
        {
            "...": "...",
            "...": "...",
            "url": "https://buy.solei.to/solei_cl_..." // [!code ++]
        }
        ```
        It looks like below:
...
<Steps>
    <Step title = "Create a Checkout Session using the API">
        ...
        ```
    Find all the available parameters along with the description in the [Create Checkout Session API](https://solei.to/docs/api-reference/checkouts/create-session).
    </Step>
    <Step title="Open the Checkout Session URL">
        ...
        {
            "...": "...",
            "url": "https://buy.solei.to/solei_c_...", // [!code ++]
            "...": "..."
        }
        ```
        It looks like below:
