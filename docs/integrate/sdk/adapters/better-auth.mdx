...
Enable the `createCustomerOnSignUp` [Solei plugin configuration option](#polar-plugin-configuration-options) to automatically create a new Solei Customer when a new User is added in the BetterAuth database.
...
[Source code](https://github.com/nerd-zero/solei-adapters/blob/main/packages/polar-betterauth/src/plugins/checkout.ts)
...
[Source code](https://github.com/nerd-zero/solei-adapters/blob/main/packages/polar-betterauth/src/plugins/usage.ts)
...
[Source code](https://github.com/nerd-zero/solei-adapters/blob/main/packages/polar-betterauth/src/plugins/webhooks.ts)
...
<Steps>
  <Step title="Configure Webhook Endpoints in Solei">
    Configure a Webhook endpoint in your Solei Organization Settings page by following [this guide](/integrate/webhooks/endpoints). Webhook endpoint is configured at `/api/auth/polar/webhooks`.
  </Step>
...
[Source code](https://github.com/nerd-zero/solei-adapters/blob/main/packages/polar-betterauth/src/plugins/portal.ts)
