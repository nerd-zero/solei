...
```
https://solei.to/oauth2/authorize?response_type=code&client_id=solei_ci_j3X95_MgfdSCeCd2qkFnUw&redirect_uri=https%3A%2F%2Fexample.com%2Fcallback&scope=openid%20email
```
...
```
https://solei.to/oauth2/authorize?response_type=code&client_id=solei_ci_j3X95_MgfdSCeCd2qkFnUw&redirect_uri=https%3A%2F%2Fexample.com%2Fcallback&scope=openid%20email&sub_type=user
```
