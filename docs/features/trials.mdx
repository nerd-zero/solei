...
Trials are a great way to let potential customers experience your product before committing to a subscription. With Solei, you can easily set up free trials for your subscription products.
...
When this feature is enabled, Solei tracks trial redemptions using:
