---
title: "Affonso Affiliates with Solei"
sidebarTitle: "Affonso Affiliates"
---

This guide explains how to integrate
[Affonso](https://affonso.io)'s affiliate marketing software with your Solei
...
### 1. Create a Solei Access Token for Affonso

First, you'll need to create an API token in Solei that Affonso can use to communicate with your account:

1. Login to your **Solei Dashboard**
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Solei_Affonso_1.mp4"
  type="video/mp4" />
</video>


### 2. Set Up Webhooks in Solei

After connecting your Solei account with Affonso, you'll [receive a webhook URL and secret from Affonso](https://affonso.io/app/affiliate-program/connect). Add these to your Solei account:

1. Go to **Settings** → **Developers** → **Webhooks** in your Solei Dashboard
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Solei_Affonso_2.mp4"
  type="video/mp4" />
</video>
...
### 5. Pass Referral Data to Solei Checkout
...
// Create checkout session with Solei
...
3. When the user makes a purchase, the referral ID is passed to Solei as metadata
4. Solei's webhook notifies Affonso about the purchase
...
More details about the integration: [Solei Affiliate Program](https://affonso.io/solei-affiliate-program)
