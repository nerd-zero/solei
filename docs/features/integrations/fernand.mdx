---
title: "Solei Integration in Fernand"
sidebarTitle: "Fernand"
description: "Learn how to sync customer and payment data from Solei to Fernand."
---
...
After connecting your [Solei](https://solei.to/) account to Fernand, you’ll be able to see customer payment information and product access details directly within each customer conversation.
...
## How to connect Fernand with Solei
...
2. Click on **Connect Solei**.
3. You'll be redirected to Solei to authorize the connection.
4. Once approved, Fernand will begin syncing customer data automatically.

That’s it! You’ll now see Solei customer info directly in Fernand's conversation list and sidebar.

---

## How to automate your inbox with Solei data

Once Solei is connected, you can create automation rules in Fernand based on Solei data.
...
<Steps>
  ...
  <Step title="Select a condition">
    Now add a condition based on Solei data. For example:
...
If you ever want to disconnect Solei from your Fernand workspace:
<Steps>
<Step title="Go to the Integrations page."></Step>
<Step title="Click Disconnect next to Solei."></Step>
</Steps>

Deleting your organization on Fernand will also remove the Solei integration automatically.
