...
You can easily offer customers and subscribers access to downloadable files with Solei.
...
Deleting a file permanently deletes it from Solei and our S3 buckets except for the metadata. Disable the file instead if you don't want it permanently deleted.
