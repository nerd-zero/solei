...
Solei offers an ingestion framework to work with Solei's event ingestion API.
...
We're always looking for ways to improve our ingestion strategies. Feel free to contribute — [Solei Ingestion SDK](https://github.com/nerd-zero/solei-ingestion).
