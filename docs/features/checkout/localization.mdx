...
```bash
curl -X POST https://api.solei.to/v1/checkouts/ \
...
Want to help us review translations for an upcoming language? Reach out at [translations@solei.to](mailto:translations@solei.to).
...
- Open an issue on [GitHub](https://github.com/nerd-zero/solei)
- Email us at [pieter+i18n@solei.to](mailto:pieter+i18n@solei.to)
