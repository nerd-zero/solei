...
| `solei-team`            | Reserved for our internal team                                           |
...
| --------------------- | -------------- | ----------------------------------------------------------------------------------------------------------  |
| **solei**             | 🟢 Public      | Default to public for all our features, tasks and bugs                                                      |
| **solei-internal**    | 🔒 Private     | Internal tasks we need to keep private, e.g customer-specific data, internal ops or surprise launches       |
| **solei-adapters**    | 🟢 Public      | *Redirected/submitted to `solei`*                                                                           |

Making it easy to coordinate our efforts in public with some exceptions in `solei-internal` only available to the team.
...
**Actions:**
- If it's a support request: ask the user to write to support@solei.com and close the issue.
