...
| **Monthly to yearly** |  | Would be a switch of products in Solei |  | Would be a switch of products in Solei |
| **Yearly to monthly** | Sets billing anchor to “now” (when the downgrade happened) and starts the monthly subscription from then

+ adds remaining amount to customer balance | Would be a switch of products in Solei |  | Would be a switch of products in Solei |
...
Use existing `BillingEntry` data model as described in [solei#6118](https://github.com/soleisource/solei/issues/6118).
...
- Data
    ...
    ```json
    {
      ...
      "object": "invoice",
      "account_country": "US",
      "account_name": "francois@solei.sh sandbox",
      ...
      "customer_email": "francois+cr5@solei.sh",
      "customer_metadata": {},
      "customer_name": "FV",
      "customer_phone": null,
